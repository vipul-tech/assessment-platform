    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      <li class="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-danger">Ongoing Exam</b>
        </Link>
      </li>
      ...
      <li class="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-danger">Upcoming Exams</b>
        </Link>
      </li>
      <li class="nav-item">
        <Link
          ...
          aria-current="page"
        >
          <b className="text-danger">Exam Results</b>
        </Link>
      </li>
      <li class="nav-item">
        <div class="nav-link active" aria-current="page">
          <b className="text-danger" onClick={viewStudentProfile}>
            My Profile
          </b>
          <ToastContainer />
        </div>
